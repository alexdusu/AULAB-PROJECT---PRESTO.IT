<nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top m-0">
    ...
    <div class="container-fluid dropdownbg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                {{-- <li>
                    <a class="nav-link a-navbar" href="{{ route('announcements.index') }}">BANANA</a>
                </li> --}}
                
                {{-- <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top m-0 mb-5"> --}}
                    
                    {{-- ! LOGO --}}
                    {{-- <li class="nav-item">
                        <a class="navbar-brand logo-font px-3 " href="{{ route('home') }}">Presto</a>
                    </li> --}}
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu dropdown-menu-end bg-p dropdown-media-utente">
                            ...
                            <li class="nav-item">
                                <a class="a-navbar nav-link position-relative text-center" href="{{ route('revisor.index') }}">Area Revisore
                            ...
                            @endif
                            <li class="text-center nav-item ">
                                <a class="nav-link a-navbar text-center" href="{{ route('announcements.create') }}">Crea Annuncio</a>
                            </li>
                            <li>
    ...
    {{-- 
        <li class="nav-item dropdown">
            <a class=" a-navbar nav-link dropdown-toggle" href="#" id="categoriesDropdown"
            role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Categorie
        </a>
        <ul class="dropdown-menu dropdown-categorie" aria-labelledby="categoriesDropdown">
            @foreach ($categories as $category)
    ...
    {{-- <li class="nav-item">
        <a class="a-navbar nav-link" href="#">Contattaci</a>
    </li> --}}
    {{-- </ul>
        @auth
        <ul class="navbar-nav  mb-2 mb-lg-0 ">
            <li class="nav-item ">
                <a class="nav-link dropdown-toggle a-navbar" href="#" role="button"
                data-bs-toggle="dropdown" aria-expanded="false">
                {{ Auth::user()->name }}
            </a>
            <ul class="dropdown-menu dropdown-menu dropdown-menu-end bg-p">
    ...
    @else
    <a class="nav-link mx-2 a-navbar" href="{{ route('login') }}">Accedi</a>
    <a class="nav-link mx-2 a-navbar" href="{{ route('register') }}">Registrati</a>
</div>
@endauth --}}
{{-- ! LANG  --}}
{{-- ? FINE LANG --}}
